"""
Django settings for demo_radio_tracking_40929 project.
...
ROOT_URLCONF = 'demo_radio_tracking_40929.urls'
...
WSGI_APPLICATION = 'demo_radio_tracking_40929.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_radio_tracking_40929 API",
    "DESCRIPTION": "API documentation for demo_radio_tracking_40929 App",
    "VERSION": "v1",
}
